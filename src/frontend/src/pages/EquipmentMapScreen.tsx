...
export default function EquipmentMapScreen({
  ...
  // Map tile loading indicator — brief 800ms on mount
  const [isMapLoading, setIsMapLoading] = useState(true);
  useEffect(() => {
    const t = setTimeout(() => setIsMapLoading(false), 800);
    ...
    <PageTransition>
      ...
      >
            ...
            {FILTERS.map((f) => (
              <button
                ...
                style={{
                  ...
                  boxShadow:
                    filter === f.value ? "0 0 0 1px #0078D2" : undefined,
                  minHeight: "32px",
                }}
        ...
        <div className="flex-1 relative" style={{ minHeight: "300px" }}>
          {/* Map loading overlay — disappears after 800ms */}
          {isMapLoading && (
            <div
            ...
            >
              <LoadingSpinner size="md" label="Loading map…" />
            </div>
          )}
          {pinGroups.length === 0 && !isMapLoading && (
            <div
